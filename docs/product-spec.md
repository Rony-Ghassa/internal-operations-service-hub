...
- The AI-assisted classification must only return one of the Request Types allowed by the system.
...
- the system will not include an AI chatbot or automatic replies. AI is only used to assist with Request Type classification.
...
- when AI-assisted classification succeeds, the result should be one of the Request Types allowed by the system.
