...
This document describes the Week 2 implementation scope at the time it was completed.
...
This Week 2 implementation used in-memory data and focused only on Request status transitions.

Later weeks expanded the project with:

- React frontend
- SQLite persistence
- Request routing
- Employee request tracking
- Department Staff handling
- authorization rules
- automated tests
- AI-assisted Request Type classification

The Week 2 document is kept as a record of the earlier development milestone.